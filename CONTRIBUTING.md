...
Do not report an unpublished candidate as a release. The current stable version is 0.8.5; 1.0.0 remains unpublished until the maintainer gives final publication approval and creates the release.
