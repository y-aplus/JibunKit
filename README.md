> 最新公開版: [0.6.0](https://github.com/y-aplus/JibunKit/releases/tag/0.6.0)。1.0は未達で、mainでは幅広いFeatureの非干渉共存を開発中です。
...
公開版は[0.6.0](https://github.com/y-aplus/JibunKit/releases/tag/0.6.0)。1.0に向けた開発は継続中です。[0.6.0の変更と検証範囲](release-notes-0.6.0.md)を参照してください。現在のビルドはTuist／Swift PackageとGitHub ActionsのmacOS／Xcode経路を使います。App IntentsメタデータとWidgetを含むIPAを生成します。
