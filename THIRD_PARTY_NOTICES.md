...
| [Xcodeproj 1.27.0](https://github.com/CocoaPods/Xcodeproj) | 一時生成したXcode projectへシミュレーター用UIテストtargetを追加 | [MIT License](https://github.com/CocoaPods/Xcodeproj/blob/1.27.0/LICENSE)。CIの開発用gemでありIPAへ同梱しない |
