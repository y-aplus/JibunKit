...
def validate_metadata(host, share, entitlements):
    assert share["CFBundleIdentifier"] == host["CFBundleIdentifier"] + ".Share"
    ...
    assert extension["NSExtensionPrincipalClass"].endswith(".ShareViewController")
...
def main():
    ...
    print(f"passed: embedded Share executable/arm64/metadata/version/App Group/signature: {share}")
