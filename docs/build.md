...
ビルド・Simulator成功は実機の上書き更新、SideStore再署名、Widget・Shortcutsの保証ではない。0.8.0候補は[出荷照合](verification/2026-09-15-0.8-release.md)、公開済み0.7.0は[当時の記録](verification/2026-09-13-0.7-release.md)、直前0.6.0の出荷検証は[公開記録](verification/2026-09-12-0.6-release.md)、公開後mainの追加は[現在状態](status.md)を参照する。Tuist移行時の記録は当時のsourceの履歴である。
