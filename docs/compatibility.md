...
更新日: 2026-09-15。公開候補0.8.0/build10、公開操作前の安定版0.7.0とmain・開発branchの区別は[現在状態](status.md)を参照。
...
需要調査Issue #6は受領済みで、1.0の最終対応範囲は0.8.0完了時にユーザーが決定する。minorごとに[現状文書の全件確認](ci-boundaries.md#マイナー版の文書・出荷gate)を行う。
