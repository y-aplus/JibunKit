...
対象P0-1/3/6、合格条件は[plan.json](plan.json)。P0-Aは0.7.0でCI・一括実機を確認済み（[証拠](../verification/2026-09-12-p0-a.md)）。以下は着手時の契約・分担を保持したもので、現在の作業指示や単独の成功証拠ではない。需要調査はその後Issue #6として受領済み。
