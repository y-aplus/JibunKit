...
2026-09-14、P1-A実装中。公開0.7.0にはまだ含まれない。native provider/所有試験23件とmacOS別process試験は成功。本体UIで判明した受信/破棄ボタンの干渉を修正し、CI 34792716605で再検証中。Swift/iOS・OS共有シートの受入結果は[検証記録](../verification/2026-09-13-p1-a.md)で区別する。
