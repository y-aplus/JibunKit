...
更新日: 2026-09-13。P0-AとP0-B `d1adb8e`の非実機条件を検証し、main `36bda79`へ反映。P0-Cを含む0.7.0 build 8候補`e84402f9154688664fae15080d5bb5b393fd4798`を固定し、CI 34704117433を開始したが結果は未確認。公開版0.6.0、main、未検証候補を区別する。
...
P0-A/P0-Bの非実機条件を確認済み。P0-C（追加・更新・0.7.0出荷）は[契約](delivery/P0-C-contract.md)に従い、追加診断と実hostへの片側Package更新を候補へ含めた。候補CI 34704117433は開始済みだが、成功、artifact、実機、配布整合性はいずれもまだ証拠へ採用していない。
