...
P2-6はidle/外観・Spotlight選択item・Widget翻訳・採用P2権限用途説明を採用し、既存成果の再利用と追加fixtureのnative検証が成功。idleの実点灯/通常消灯復帰は確認済み。全採用範囲の実OS描画証拠は未完了でpartial。[採用契約](delivery/P2-adoption-contract.md)。
