...
Focused simulator CI pending. If this simulator runtime does not expose the Now Playing module through public XCTest accessibility after one normal top-right Control Center gesture, its hierarchy and screenshot are retained as boundary evidence rather than adding timing or coordinate retries.
