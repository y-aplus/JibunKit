...
対象コードは4eb784d3f8f313eef9c6566f5729006e655af164。CI34979381516と配布物の検査は未完。診断IPA/通常IPAのリンクとSHAを確定し、この冒頭を更新してから依頼する。以下は0.8.xで一括確認する予定で、1.0まで延期する意味ではない。1操作ごとのcommit/pushはしない。
