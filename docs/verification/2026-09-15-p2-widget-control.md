...
現在: CI35027469173（e984d44）はnative/診断hostの両jobが成功。通常job34979381516は差分確認して再利用。確認用prereleaseを公開し、全4assetの無認証再取得・完全一致/CRCを確認。一括実機確認も完了し、0.8.1/build11の出荷CI35038442208・main統合・公開取得まで完了。P2-7完了、1.0全体は未完。以下の待機記述は履歴。
