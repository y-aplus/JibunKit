...
出荷候補VERSIONは0.8.5/build15、最新公開版PREVIOUSは0.8.4/build14。未公開です。1.0.0の完成判定ではありません。
...
- 0.8.5通常版のbuild/IPA・限定UI回帰は準備中。今回の通常IPAの実機結果は未受領です。
...
公開時に確定source、通常CI、IPAサイズ・SHA-256を追記します。旧release/tag/assetは差し替えません。
